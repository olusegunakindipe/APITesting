<?php  //[STAMP] a685571302fb09e0e122eefdee9c3152
...
trait ApiTesterActions
{
     ...
     *
     *
     * @see \Helper\Api::CheckForEmptiness()
     */
    public function CheckForEmptiness($data) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('CheckForEmptiness', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\Api::CheckPackageIsEmpty()
     */
    public function CheckPackageIsEmpty($data) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('CheckPackageIsEmpty', func_get_args()));
    }
